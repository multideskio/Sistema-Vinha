...
var letter = document.getElementsByClassName("pass-lower");
var capital = document.getElementsByClassName("pass-upper");
var number = document.getElementsByClassName("pass-number");
var length = document.getElementsByClassName("pass-length");

// When the user clicks on the password field, show the message box
myInput.onfocus = function () {
    document.getElementsByClassName("password-contain").style.display = "block";
};

// When the user clicks outside of the password field, hide the password-contain box
myInput.onblur = function () {
    document.getElementsByClassName("password-contain").style.display = "none";
};
