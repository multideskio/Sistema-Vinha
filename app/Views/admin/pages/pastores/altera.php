...
<div class="col-xxl-12">
    <h1 class="mb-3 fw-bolder">Gerenciamento de pastores</h1>
</div>
<div class="row">
    <div class="col-xxl-3">
        <div class="card">
            ...
            <div class="card-body p-4">
                <div class="tab-content">
                    <div class="tab-pane active" id="personalDetails" role="tabpanel">
                        <?= form_open('api/v1/pastores/' . $idSearch, 'class="formGeral" autocomplete="off"') ?>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-3">
...
<script src="/assets/js/custom/pastoresUpdate.min.js?v=1.0.0"></script>
<script src="/assets/js/custom/listaTransacoes.js?V=2"></script>
<?= $this->endSection() ?>