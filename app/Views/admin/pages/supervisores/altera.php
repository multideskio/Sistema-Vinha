...
<div class="col-xxl-12">
    <h1 class="mb-3 fw-bolder">Gerenciamento de supervisores</h1>
</div>
<div class="row">
    <div class="col-xxl-3">
        <div class="card">
            ...
            <div class="card-body p-4">
                <div class="tab-content">
                    <div class="tab-pane active" id="personalDetails" role="tabpanel">
                        <?= form_open('api/v1/supervisores/' . $idSearch, 'class="formGeral" autocomplete="off"') ?>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
...
<script src="/assets/js/custom/supervisoresUpdate.js"></script>
<?= $this->endSection() ?>