<div class="modal fade" id="cadastrarSupervisor" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="cadastrarSupervisorLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="cadastrarSupervisorLabel">Cadastro de supervisor</h5>
            ...
            <div class="modal-body">
                <div class="row gx-1">
                    <div class="col-md-6">
                        <label for="selectGerentes" class="text-danger">Selecione um gerente</label>
                        <select name="selectGerentes" id="selectGerentes" class="form-select" required></select>
                    </div>
                    <div class="col-md-6">
                        <label for="selectRegiao" class="text-danger">Selecione uma região</label>
                        <select name="selectRegiao" id="selectRegiao" class="form-select" required></select>
                    </div>
                </div>
                <div class="row gx-1">
