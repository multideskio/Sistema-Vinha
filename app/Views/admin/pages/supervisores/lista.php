...
<div class="col-xxl-12">
    <h1 class="mb-3 fw-bolder float-start">Gerenciamento de supervisores</h1>
    <!-- Button trigger modal -->
    <button type="button" class="btn btn-success float-end mb-2" data-bs-toggle="modal" data-bs-target="#cadastrarSupervisor">
