...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => lang('Paginas.novaconta.titlePage', [$rowConfig['empresa']]))); ?>
                        ...
                        <div class="card mt-4">
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    ...
                                    <div class="mb-3">
                                        <label for="tipoCadastro" class="form-label">Email <span class="text-danger">*</span></label>
