<div id="divIgreja" style="display: none;">
    <?= form_open("api/v1/public/igreja", 'class="needs-validation formSend00" novalidate') ?>
    <div class="mb-3">
    ...
    <div class="mb-3">
        <label for="cepIgreja">CEP <span class="text-danger">*</span></label>
        <input type="text" name="cep" id="cepIgreja" class="form-control cep" placeholder="00000-000" required>
        <div class="invalid-feedback">
            Informe seu CEP
        </div>
    </div>
    ...
    <div class="mb-3">
        <label for="whatsappIgreja">Telefone/WhatsApp <span class="text-danger">*</span></label>
        <input type="text" name="whatsapp" id="whatsappIgreja" class="form-control whatsapp" placeholder="+55 (00) 9 0000-0000" required>
        <div class="invalid-feedback">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="nomeTesoureiro" id="nomeTesoureiro" class="form-control whatsapp" placeholder="First name treasure" required>
        <div class="invalid-feedback">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="sobreTesoureiro" id="sobreTesoureiro" class="form-control whatsapp" placeholder="Last name treasure" required>
        <div class="invalid-feedback">
    ...
    <div class="mb-3">
        <label for="cpfTesoureiro" class="form-label">CPF Tesoureiro<span class="text-danger">*</span></label>
        <input type="text" class="form-control cpf" id="cpfTesoureiro" name="cpfTesoureiro" placeholder="Enter CPF" required>
        <div class="invalid-feedback">
    ...
    <div class="mb-3">
        ...
        <input type="date" class="form-control cpf" id="dataFundacao" name="dataFundacao" placeholder="Date of foundation" required>
        <div class="invalid-feedback">
            Informe a data da fundação
        </div>
    </div>
    <div class="mb-3">
        <label class="form-label" for="password-input-igreja">Senha <span class="text-danger">*</span></label>
        <div class="position-relative auth-pass-inputgroup">
            <input type="password" class="form-control pe-5 password-input" onpaste="return false" placeholder="Enter password" id="password-input-igreja" name="password" aria-describedby="passwordInput" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required autocomplete="off">
