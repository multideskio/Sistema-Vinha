        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 right-side mt-5 pt-5">
                <div class="text-center">
                    ...
                    <h3 class="title mb-1">Houve um problema</h3>
                </div>
                            ...
                            <div class="card-body p-4">
                                <div class="p-2 mt-4">
                                    ...
                                    <div class="mt-4 pt-2 text-center">
                                        <h2 class="fw-bold">LINK EXPIRADO</h2>
                                        <p class="text-muted mx-4 fs-4">Esse link não está mais disponivel
                                        </p>
                                        <div class="mt-4">
                                            <a href="/" class="btn btn-dark btn-lg w-100">FAZER LOGIN</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- end card body -->
