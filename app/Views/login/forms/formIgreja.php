<div id="divIgreja" style="display: none;">
    ...
    <div class="mb-3">
        <label for="i_cnpj" class="form-label">CNPJ <span class="text-danger">*</span><small class="text-muted">Apenas números</small></label>
        <input type="text" class="form-control cnpj" id="i_cnpj" name="cnpj" placeholder="Enter cnpj" required>
        <div class="invalid-feedback">
            Informe seu CPF
        </div>
    </div>
    ...
    <div class="mb-3">
        ...
        <div class="position-relative" id="auth-pass-inputgroup-igreja">
