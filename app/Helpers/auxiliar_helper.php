...
if (!function_exists('getCardType')) {
    function getCardType($number)
    {
        ...
        $cardTypes = [
            'Visa' => '/^4[0-9]{12}(?:[0-9]{3})?$/',
            'Master' => '/^5[1-5][0-9]{14}$/',
            'Amex' => '/^3[47][0-9]{13}$/',  // Amex para American Express
            'ELO' => '/^((636368|438935|504175|451416|636297|5067|4576|4011)\d{0,10})$/',
            'Aura' => '/^50[0-9]{17}$/', // Atualizado para reconhecer cartões Aura
            'Diners' => '/^3(?:0[0-5]|[68][0-9])[0-9]{11}$/',
            'Discover' => '/^6(?:011|5[0-9]{2})[0-9]{12}$/', // Corrigido de Discovery para Discover
